...
// 1. Busca os dados da planilha usando o link direto de exportação CSV
async function buscarCardapioGoogleSheets() {
  try {
    const url = `https://docs.google.com/spreadsheets/d/${process.env.GOOGLE_SHEET_ID}/export?format=csv`;
